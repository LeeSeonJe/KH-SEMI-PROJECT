...
<select id="first" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
</select>
				
<select id="seoul" class="sggu" style="width: 111px;">
    <option value="first" selected>시/군/구 선택</option>
...
<select id="busan" class="sggu" style="width: 111px;">
    <option value="first" selected>시/군/구 선택</option>
    <option value="강서구">강서구</option>
...
<select id="daegu" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
	<option value="남구">남구</option>
...
<select id="incheon" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="gwangju" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="daejeon" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="ulsan" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
	<option value="남구">남구</option>
	<option value="동구">동구</option>
	<option value="북구">북구</option>
...
<select id="sejong" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
	<option value="세종시">세종시</option>
</select>

<select id="gyeonggi" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="gangwon" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="chungcheongbuk" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="chungcheongnam" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="jeollabuk" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="jeollanam" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="gyeongsangbuk" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="gyeongsangnam" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
...
<select id="jeju" class="sggu" style="width: 111px;">
	<option value="first" selected>시/군/구 선택</option>
