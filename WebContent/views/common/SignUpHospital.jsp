				...
				<tbody>
					<tr>
						...
						<td><input class="input-standard" type="text"
							placeholder="아이디를 입력하세요." id="id" onkeyup="test3();">
					...
					<tr>
						<td>비밀번호</td>
						<td><input class="input-standard" type="password"
							placeholder="비밀번호를 입력하세요." id="pwd" onkeyup="test1();"></td>
						<td></td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						<td>비밀번호 확인</td>
						<td><input class="input-standard" type="password"
							placeholder="비밀번호를 입력하세요." id="pwd2" onkeyup="test2();"></td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						<td>병원 이름</td>
						<td><input class="input-standard" type="text"
							placeholder="병원 이름을 입력하세요." /></td>
					</tr>
					<tr>
						<td>병원 전화번호</td>
						<td><input class="input-standard" type="email"
							placeholder="이메일을 입력하세요." /></td>
					</tr>
					<tr>
						<td>병원 주소</td>
						<td><input class="input-standard" type="text"
							placeholder="병원 대표전화번호를 입력하세요." /></td>
					</tr>
					<tr>
						<td>사업자등록증</td>
					</tr>
					<tr>
						<td><input class="input-standard" type="text" readonly
							placeholder="사업자등록증 사진" />
							<button class="btn-standard">파일 선택</button></td>
					</tr>
					<tr>
						<td><input class="input-standard" type="text" readonly
							placeholder="병원사진" />
					...
					<tr>
						<td><input class="input-standard" type="text"
							placeholder="내용을 작성해 주세요" /></td>
					</tr>
					<tr>
						<td colspan="2" class="td-center"><button
								class="btn-standard" type="submit">신청</button>
							<button class="btn-standard">취소</button></td>
					</tr>
