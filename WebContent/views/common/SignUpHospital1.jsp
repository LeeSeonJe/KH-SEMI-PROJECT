...
<body>
	...
	<form
		action="<%=request.getContextPath()%>/views/common/SignUpCustomer2.jsp"
		...
		<div class="loginForm">
			...
			<div class="mLogin">
				...
				<div
					style="width: 80%; height: 50px; float: left; margin-left: 10%;">
					<div class="SUIIDB">
				...
				<div
					style="width: 80%; height: 80px; float: left; margin-left: 10%;">
					<div class="SUIIDB">
				...
				<div class="SUChk">
					<br>
					<br> &nbsp;&nbsp;&nbsp;&nbsp; <label class="form-switch"style = "margin-top : 14px;">
						<input class="toggleA" type="checkbox" id="tglA"> <i></i>
					</label> &nbsp;&nbsp; 코스메딕 이용약관, 개인정보 수집 및 이용동의, 이벤트 및 프로모션 안내메일 수신(선택)에 모두
					동의합니다.
				</div>
				<div class="SUChk2">
					<br> <br> &nbsp;&nbsp;&nbsp;&nbsp; <label
						class="form-switch" style = "margin-top : 24px;"> <input class="toggleB"
				...
				<div class="SUChk2">
					...
					<div class="SUChkBF">
						<input type="button" class="SUChkBt" value="자세히 보기"
							onclick="popUp2()" style="background-color: #4BD763">
					</div>
				</div>
				<div class="SUChk2">
					<br> <br> &nbsp;&nbsp;&nbsp;&nbsp; <label
						class="form-switch" style = "margin-top : 24px;"> <input class="toggleC"
						type="checkbox" id="tgl3"> <i></i>
					</label> &nbsp;&nbsp; 이벤트 및 프로모션 알림 메일 수신
					<h3 style="font-size: 13pt; color: #4BD763; display: inline-block;">
						(선택)</h3>
					<div class="SUChkBF">
						<input type="button" class="SUChkBt" value="자세히 보기"
							onclick="popUp3()" style="background-color: #4BD763">
					</div>
				</div>
				<div class="SUB">
					<br> <br> <br> <br> <input class="SUBC"
						type="button" value="비동의"
						style="background-color: white; border: 1px solid black;"
						onclick="location.href='loginedMain.jsp' "> <input
						class="SUBC" type="button" value="동의"
						style="background-color: #595959; border: 1px solid #595959; color: white;"
						id="Dummy"> <input class="SUBC" type="button" value="동의"
						style="background-color: #4BD763; border: 1px solid #4BD763; color: white;"
						id="SUSubmit" onclick="location.href='SignUpHospital2.jsp'">
				</div>
			</div>
		</div>
	</form>
	...
	<script>
		...
		function popUp3(){
			window.open("<%=request.getContextPath()%>/views/common/SignUpTerm3.jsp",
							"COSMEDIC이용약관",
							"width=460 , height = 500 , left = 300, top = 150");
		}
