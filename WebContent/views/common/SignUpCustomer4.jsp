...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/commonCss/SignUpCustomer4.css"
	type="text/css">
	...
	<div class="loginForm">
		...
		<div class="mLogin">
			...
			<div class="SUI">
				...
				<div class="SUII">
					<img class="SUImg"
						src="<%=request.getContextPath()%>/resources/images/SUChk4_1_1.png">
				</div>
			</div>
			...
			<div style = "width : 80%; height : 100px; float : left; margin-left : 10%;">
				<div class = "SUIIDB">
					<div class = "SUIIDBI2">
						약관동의
					</div>
			...
			<div class="SUChk">
				...
				<div class = "SUChkConfirm2">
					<div class = "SUChkConfirm2_1">
						...
						국내 최고의 뷰티정보 사이트 COSMEDIC의 회원이 되신 것을 축하드립니다.<br><br>
						이제 COSMEDIC의 더욱더 아름다운 뷰티세상 즐기시기 바랍니다.<br><br>
						감사합니다.
					</div>
					<div class = "SUChkConfirm1">
					</div>
