...
<body>
						...
						<li>
							<div class="ranking-list">
								...
								<div class="cos-detail">
									...
									<h5 class="cos-rank-link" ><%= list.get(i).getCosmetic_name() %><input class="hiddenNo" type="hidden" value="<%= list.get(i).getMiddle_no() %>"></h5><br><br>
	...
	<script>
			...
			$.ajax({
				...
				success: function(data){
					...
					for(var i in data) {
						...
						var $h5 = $('<h5 class="cos-rank-link"></h5>').html(data[i].cosmetic_name)
		...
		$('#category-btn').on('click', function(){
			...
			var count = 0;
			$.ajax({
				url: '/COSMEDIC/bCategory.ch',
				data: {
					middleCategory:middleCategory, bname:bname
				},
				success: function(data){
					console.log(data)
					$('#ul-area').html("");
