...
/**
 * Servlet implementation class BrandCosmeticFilterServlet
 */
@WebServlet("/bCosmetic.ft")
public class BrandCosmeticFilterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BrandCosmeticFilterServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(skinTypeFilter);
		System.out.println(middle_no);
